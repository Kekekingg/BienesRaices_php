    ...
    <main class="contenedor seccion">
        ...
        <form action="" class="formulario">
            ...
            <fieldset>
                ...
                <select id="opciones">
                    <!--El value de Compra y Vende es lo que se manda al servidor-->
            ...
            <fieldset>
                ...
                <div class="forma-contacto">
                    <!--Para que solo se seleccione un solo radio button el name debe de ser igual pero el value diferente -->
